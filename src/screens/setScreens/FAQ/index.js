        ...
        <View style={styles.content}>
          ...
          {question1 && (
            <Text style={styles.text2}>
              O FitHouse é um aplicativo com o objetivo de ajudar as pessoas a
              alcançar seus objetivos de condicionamento físico e saúde por meio
              de programas de exercícios personalizados e acompanhamento de
              progresso.
            </Text>
          )}
